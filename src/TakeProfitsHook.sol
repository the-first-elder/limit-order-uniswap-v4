...
contract TakeProfitsHook is BaseHook, ERC1155 {
        ...
        external
    {
        ...
        uint256 positionTokens = balanceOf(msg.sender, positionId);
        if (positionTokens < inputAmountToClaimFor) revert NotEnoughToClaim(); // obviously this only works if this 1:1

        uint256 totalClaimableForPosition = claimableOutputTokens[positionId]; // how much they can get
        uint256 totalInputAmountForPosition = claimTokensSupply[positionId]; // how much the personset
